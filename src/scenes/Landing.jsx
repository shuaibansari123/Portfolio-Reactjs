...
//             Backend Engineer with 3+ years building scalable, cloud-native systems on GCP and AWS; expertise in Python, Django, high-performance APIs, and event-driven architectures.
//           </p>
//         </motion.div>
      ...
      <div className="z-30 basis-2/5 mt-24 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start leading-relaxed">
            ...
            cloud-native systems on GCP (primary) and AWS. Specialized in Python,
            Django, high-performance APIs, event-driven architectures, and
            production-grade backend platforms with strong focus on reliability,
